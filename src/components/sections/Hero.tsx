...
const Hero = () => {
    return (
        <div className='h-screen bg-white py-6 sm:py-10  '>
            <div className="flex flex-col md:flex-row items-start px-8 gap-4  ">
                <div className='flex items-start gap-4 md:w-3/5 flex-col '>
                    <h1 className='font-dm_sans text-4xl sm:text-5xl md:text-6xl leading-6 tracking-tight bg-gradient-to-r font-bold from-primary to-accent bg-clip-text text-transparent  '>Unleash Your Creativity with AI-Generated Images</h1>
                    <p className='text-neutral-900 text-justify mb-3 max-w-2xl font-medium text-lg leading-7 '>
