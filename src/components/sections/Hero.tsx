        ...
        <div className='bg-white py-6 sm:py-10  '>
            <div className="flex flex-col md:flex-row items-start px-8 gap-4  ">
                <div className='flex items-start gap-4 md:w-3/5 flex-col '>
                    <h1 className='font-dm_sans text-4xl sm:text-5xl md:text-6xl  tracking-tighter bg-gradient-to-r font-bold from-primary to-accent bg-clip-text text-transparent  '>Unleash Your Creativity with AI-Generated Images</h1>
                    ...
                    <div className='flex items-center gap-5 '>
                        <button className='py-2 px-5 bg-secondary  shadow-[2px_3px_#000] hover:shadow-[3px_4px_#000] duration-300 rounded-xl  ' >Get started</button>
                        <button className='py-2 px-5 bg-accent duration-300 rounded-xl hover:bg-secondary  ' >Free Trial</button>
                    </div>
                </div>
